...
#define MODBUS_TIM_INSTANCE                 TIM2
#define MODBUS_TIM_CLK_ENABLE               __HAL_RCC_TIM2_CLK_ENABLE
#define MODBUS_TIM_IRQ_NUMBER               TIM2_IRQn
#define MODBUS_TIM_IRQ_HANDLER              TIM2_IRQHandler
